...
int main(int argc, char *argv[]){
        ...
        if(argc==6) {
                ...
                apply_burn(size,forest,6,_probability,_density,_proportion,cycles);
        ...
        if(argc==5) {
                ...
                density = str_to_int(argv[3]);
                proportion = str_to_int(argv[4]);
                _probability = ((float)probability)/100;
                _density=((float)density)/100;
                _proportion = ((float)proportion)/100;
                if(size>40 || size<5) {
                ...
                init_forest(size,forest);
                apply_fire(size,forest,density,_proportion);
                apply_burn(size,forest,5,_probability,_density,_proportion,0);
